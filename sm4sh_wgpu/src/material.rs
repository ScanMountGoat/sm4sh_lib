...
pub fn create_bind_group2(
    ...
    let uniforms = device.create_uniform_buffer(
        ...
        &crate::shader::model::Uniforms {
            ...
            colorSampler4UV: get_parameter(mesh, "NU_colorSampler4UV").unwrap_or_default(),
            ...
            testParam0: get_parameter(mesh, "NU_testParam0").unwrap_or_default(),
            testParam1: get_parameter(mesh, "NU_testParam1").unwrap_or_default(),
            testParam2: get_parameter(mesh, "NU_testParam2").unwrap_or_default(),
            testParam3: get_parameter(mesh, "NU_testParam3").unwrap_or_default(),
            translucentColor: get_parameter(mesh, "NU_translucentColor").unwrap_or_default(),
    ...
    let effect_uniforms = device.create_uniform_buffer(
        ...
        &crate::shader::model::EffectUniforms {
            ...
            effDepthOffset: get_parameter(mesh, "NU_effDepthOffset").unwrap_or_default(),
            effMTBlendAlpha: get_parameter(mesh, "NU_effMTBlendAlpha").unwrap_or_default(),
            effMTBlendParam0: get_parameter(mesh, "NU_effMTBlendParam0").unwrap_or_default(),
            effMTBlendParam1: get_parameter(mesh, "NU_effMTBlendParam1").unwrap_or_default(),
            effMTBlendParam2: get_parameter(mesh, "NU_effMTBlendParam2").unwrap_or_default(),
            effRefractParam: get_parameter(mesh, "NU_effRefractParam").unwrap_or_default(),
            ...
            effSunShaftParams0: get_parameter(mesh, "NU_effSunShaftParams0").unwrap_or_default(),
            effSunShaftParams1: get_parameter(mesh, "NU_effSunShaftParams1").unwrap_or_default(),
            ...
            effYGradColorBottom: get_parameter(mesh, "NU_effYGradColorBottom").unwrap_or_default(),
            effYGradColorTop: get_parameter(mesh, "NU_effYGradColorTop").unwrap_or_default(),
            effYGradParam: get_parameter(mesh, "NU_effYGradParam").unwrap_or_default(),
            normalParams: get_parameter(mesh, "NU_normalParams").unwrap_or_default(),
            normalSamplerAUV: get_parameter(mesh, "NU_normalSamplerAUV").unwrap_or_default(),
        },
    );
