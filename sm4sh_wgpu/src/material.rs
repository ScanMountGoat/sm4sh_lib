...
pub fn create_bind_group2(
    ...
    let effect_uniforms = device.create_uniform_buffer(
        ...
        &crate::shader::model::EffectUniforms {
            ...
            eff_mt_blend_alpha: get_parameter(mesh, "NU_effMTBlendAlpha").unwrap_or_default(),
            eff_mt_blend_param0: get_parameter(mesh, "NU_effMTBlendParam0").unwrap_or_default(),
            eff_mt_blend_param1: get_parameter(mesh, "NU_effMTBlendParam1").unwrap_or_default(),
            eff_mt_blend_param2: get_parameter(mesh, "NU_effMTBlendParam2").unwrap_or_default(),
